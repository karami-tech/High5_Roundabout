    ...
    if singleormultiple == "m":
        ...
        for file in os.listdir(images_directory):
            ...
            for line in new_file:
                ...
                base_json["annotations"].append(annotation)
            image_id += 1
        # with open(r"C:\Users\MulderLisa\Documents\Projecten\rotondes\test2_yolo_to_coco\output2.json", "w") as outfile:
        with open(os.path.join(root_folder, "downloaded_labels_YOLO_to_COCO.json"), "w") as outfile:
            json.dump(base_json, outfile)
    else:
...
root_folder = r"C:\Users\MulderLisa\Documents\Projecten\rotondes"
# annotation_directory = r"C:\Users\MulderLisa\Documents\Projecten\rotondes\test2_yolo_to_coco\labels2"
annotation_directory = os.path.join(root_folder, "downloaded_labels_YOLO")
# images_directory = r"C:\Users\MulderLisa\Documents\Projecten\rotondes\test2_yolo_to_coco\images"
images_directory = os.path.join(root_folder, "downloaded_images")
